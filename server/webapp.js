  ...
  function WebApp(server, app) {
    ...
    this.app.get(new RegExp(home_exp), (function(_this) {
      return function(req, res) {
        ...
        if (!_this.server.rate_limiter.accept("page_load_ip", req.ip)) {
          return _this.return429(req, res);
        }
    ...
    this.app.get(/^\/[^\/\|\?\&\.]+\/[^\/\|\?\&\.]+(\/([^\/\|\?\&\.]+)?)?\/assets\/[A-Za-z0-9_-]+.(glb|obj|jpg|png|ttf|txt|csv|json|md|wasm)$/, (function(_this) {
      return function(req, res) {
