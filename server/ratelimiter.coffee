class @RateLimiter
  constructor:(@server)->
    ...
    @map.set_local_folder_user = new RateLimiterClass(@,60,20) # max 20 folder link/unlink per hour
    @map.git_op_user = new RateLimiterClass(@,5,30) # max 30 git operations per 5 minutes
