        ...
        return manager.listFiles(folder, function(files) {
          ...
          fn = function(f) {
            return queue.add(function() {
              return project.getStorage().read(user.id + "/" + project.id + "/" + folder + "/" + f.file, fileType, function(content) {
                var name;
                if (content != null) {
      ...
      return function(req, res) {
        ...
        queue.add(function() {
          return manager.listFiles("sprites", function(sprites) {
            ...
            fn = function(s) {
              return queue.add(function() {
                return project.getStorage().read(user.id + "/" + project.id + "/sprites/" + s.file, "binary", function(content) {
                  if (content != null) {
        ...
        queue.add(function() {
          return manager.listFiles("doc", function(docs) {
            ...
            fn = function(doc) {
              return queue.add(function() {
                return project.getStorage().read(user.id + "/" + project.id + "/doc/" + doc.file, "text", function(content) {
                  if (content != null) {
      ...
      return function(req, res) {
        ...
        queue.add(function() {
          return manager.listFiles("sounds", function(sounds) {
            ...
            fn1 = function(s) {
              return queue.add(function() {
                return project.getStorage().read(user.id + "/" + project.id + "/sounds/" + s.file, "binary", function(content) {
                  if (content != null) {
        ...
        queue.add(function() {
          return manager.listFiles("music", function(music) {
            ...
            fn1 = function(m) {
              return queue.add(function() {
                return project.getStorage().read(user.id + "/" + project.id + "/music/" + m.file, "binary", function(content) {
                  if (content != null) {
        ...
        queue.add(function() {
          return manager.listFiles("assets", function(assets) {
            ...
            fn1 = function(asset) {
              return queue.add(function() {
                return project.getStorage().read(user.id + "/" + project.id + "/assets/" + asset.file, "binary", function(content) {
                  if (content != null) {
