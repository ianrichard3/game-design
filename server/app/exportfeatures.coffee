          ...
          for f in files
            do (f)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/#{folder}/#{f.file}",fileType,(content)=>
                  if content?
          ...
          for s in sprites
            do (s)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/sprites/#{s.file}","binary",(content)=>
                  if content?
          ...
          for doc in docs
            do (doc)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/doc/#{doc.file}","text",(content)=>
                  if content?
          ...
          for map in maps
            do (map)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/maps/#{map.file}","text",(content)=>
                  if content?
        ...
        manager.listFiles "sounds",(sounds)=>
          for s in sounds
            do (s)=>
              queue.add ()=>
                #console.info "reading: "+JSON.stringify s
                project.getStorage().read "#{user.id}/#{project.id}/sounds/#{s.file}","binary",(content)=>
                  if content?
          ...
          for m in music
            do (m)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/music/#{m.file}","binary",(content)=>
                  if content?
          ...
          for asset in assets
            do (asset)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/assets/#{asset.file}","binary",(content)=>
                  if content?
          ...
          for src in ms
            do (src)=>
              queue.add ()=>
                ...
                project.getStorage().read "#{user.id}/#{project.id}/ms/#{src.file}","text",(content)=>
                  if content?
