...
this.AssetsManager = (function(superClass) {
  ...
  AssetsManager.prototype.checkWASMThumbnail = function(asset) {
    return this.checkThumbnail(asset, (function(_this) {
      return function() {
        return _this.createWASMThumbnail(asset.getURL(), function(canvas) {
          if (asset.element != null) {
            asset.element.querySelector("img").src = canvas.toDataURL();
          }
          return _this.updateAssetIcon(asset, canvas);
        });
      };
    })(this));
  };

  AssetsManager.prototype.createWASMThumbnail = function(url, callback) {
